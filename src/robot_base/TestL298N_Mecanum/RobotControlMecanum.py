...
while True:
   ...
   if(char == "w"):
      ...
      HBridge.setMotorLeftBack(speedleft*-1)
      HBridge.setMotorLeftFront(speedleft)
      HBridge.setMotorRightBack(speedright*-1)
      HBridge.setMotorRightFront(speedright)
      printscreen()
   ...
   if(char == "q"):
      speedleft = 0
      speedright = 0
      HBridge.setMotorLeftBack(speedleft)
      HBridge.setMotorLeftFront(speedleft)
      HBridge.setMotorRightBack(speedright)
      HBridge.setMotorRightFront(speedright)	  
      printscreen()
   ...
   if(char == "d"):      
      ...
      HBridge.setMotorLeftBack(speedleft)
      HBridge.setMotorLeftFront(speedleft*-1)
      HBridge.setMotorRightBack(speedright)
      HBridge.setMotorRightFront(speedright*-1)
      printscreen()

   # Mit der Taste "c" lenkt das Auto nach rechts bis die max/min
   # Geschwindigkeit der linken und rechten Motoren erreicht ist.
   if(char == "c"):      
      speedright = speedright - 0.1
      speedleft = speedleft + 0.1
   ...
   if(char == "x"):
      HBridge.setMotorLeftBack(0)
      HBridge.setMotorLeftFront(0)
      HBridge.setMotorRightBack(0)
      HBridge.setMotorRightFront(0)	  
      HBridge.exit()
      print("Program Ended")
      break
